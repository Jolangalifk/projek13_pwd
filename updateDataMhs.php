...
// Update ke database
$sql = "UPDATE mhs SET nim=?, nama=?, no_hp=?, umur=?, tempat_lahir=?, tanggal_lahir=?, 
        alamat=?, kota=?, jk=?, status=?, hobi=?, email=? WHERE id=?";
...
if ($exec) {
    ...
    echo "Update gagal: " . htmlspecialchars(mysqli_stmt_error($stmt));
}
